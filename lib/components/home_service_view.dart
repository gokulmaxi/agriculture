...
import 'package:agriculture/models/service.dart';
...
class HomeServiceView extends StatelessWidget {
  ...
  InkWell _buildContainer(int index, BuildContext context, Service service) {
    ...
    return InkWell(
      onTap: () => {Navigator.pushNamed(context, '/' + index.toString())},
      child: Container(
